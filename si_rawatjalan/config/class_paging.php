...
for ($i=1; $i<=$jmlhalaman; $i++){
  if ($i == $halaman_aktif){
    $link_halaman .= "<li class=\"current\">$i</li> ";
  }
else{
...
for ($i=1; $i<=$jmlhalaman; $i++){
  if ($i == $halaman_aktif){
    $link_halaman .= "<li class=\"current\"><b>$i</b></li>";
  }
else{
  $link_halaman .= "<li><a href=$_SERVER[PHP_SELF]?module=$_GET[module]&id=$_GET[id]&halaman=$i>$i</a></li> ";
}
$link_halaman .= " ";
}
return $link_halaman;
